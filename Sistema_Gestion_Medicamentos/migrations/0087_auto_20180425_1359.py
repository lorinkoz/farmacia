...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Sistema_Gestion_Medicamentos', '0086_auto_20180425_1208'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('devuelto_almacen', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='devuelto_almacen', to='Sistema_Gestion_Medicamentos.DevueltoAlmacen')),
