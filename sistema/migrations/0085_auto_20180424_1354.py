...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Sistema_Gestion_Medicamentos', '0084_auto_20180422_0241'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='justificacion',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Sistema_Gestion_Medicamentos.Justificacion'),
        ),
        migrations.AlterField(
            model_name='sala',
            name='centro_costo',
