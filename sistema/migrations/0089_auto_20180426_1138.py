...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('sistema', '0088_auto_20180425_1431'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='pedidofarmacia',
            name='producto',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='sistema.Producto'),
            preserve_default=False,
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='sistema.PedidoAlmacenDetalle'),
        ),
    ]
